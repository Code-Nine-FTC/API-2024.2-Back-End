package com.codenine.projetotransparencia;
...
public class ProjetotransparenciaApplication {

	public static void main(String[] args) {
		SpringApplication.run(ProjetotransparenciaApplication.class, args);
		...
		configuracao.put("spring.datasource.url", "jdbc:mysql://localhost:3306/projetotrasparencia"); // caminho da conexão
		...
		SpringApplication app = new SpringApplication(ProjetotransparenciaApplication.class);
